...
void main(void)
{
    ...
    do
    {
        printf("Ingrese el tamono del arreglo: ");
        scanf("%d", &TAM);
    }
    ...
    if (RES) /* Si RREESS tiene un valor verdadero —diferente de 0—, se escribe la posición en la que se encontró el elemento. */
    printf("\nEl elemeento se encuentra en la posicion %d", RES);
    else
...
/* Esta función se utiliza para localizar el elemento EE en el arreglo unidimensional A.
