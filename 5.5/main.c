...
/* La función LLeeccttuurraa se utiliza para leer el arreglo de calificaciones. */
{
    int I;
    for (I=0; I<T; I++)
    {
...
/* La función IImmpprreessiióónn se utiliza para imprimir el arreglo de frecuencias. */
{
    int I;
    for(I=0; I<T; I++)
        for (I=0; I<T; I++);
